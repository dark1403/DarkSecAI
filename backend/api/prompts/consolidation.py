def create_consolidation_prompt(reports: str) -> str:
    ...
    Please provide a consolidated analysis in JSON format with the following structure:
    {{
        "analyzedTarget": "consolidated analysis",
        "vulnerabilities": [
            {{
                "vulnerability": "consolidated vulnerability name",
                "severity": "High|Medium|Low",
                "description": "consolidated description",
                "impact": "consolidated impact",
                "recommendation": "consolidated recommendation",
                "vulnerableCode": "example payload if applicable"
            }}
        ],
