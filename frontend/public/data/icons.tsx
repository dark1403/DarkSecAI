...
export const SearchIcon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="w-5 h-5 shrink-0">
...
export const PlayIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width={800} height={800} fill="none" class="w-5 h-5" viewBox="0 0 24 24">
    <path fill="#000" d="M8.286 3.407A1.5 1.5 0 0 0 6 4.684v14.632a1.5 1.5 0 0 0 2.286 1.277l11.888-7.316a1.5 1.5 0 0 0 0-2.555L8.286 3.407z" />
  </svg>
);

export const ThreeDots = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="800" height="800" fill="#000" class="w-5 h-5 flex items-center" data-name="Layer 1" viewBox="0 0 16 16">
      <path d="M8 6.5A1.5 1.5 0 116.5 8 1.5 1.5 0 018 6.5zM.5 8A1.5 1.5 0 102 6.5 1.5 1.5 0 00.5 8zm12 0A1.5 1.5 0 1014 6.5 1.5 1.5 0 0012.5 8z" class="cls-1"></path>
    </svg>
  );
};
...
export const Steering = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="#000" version="1.1" viewBox="0 0 295.238 295.238" xmlSpace="preserve" class="w-5 h-5 text-[#22804A]">
